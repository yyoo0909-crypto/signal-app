...
function sendChat() {
  ...
  // Generate response with short delay (realistic feel)
  const delay = 800 + Math.random() * 600;
  setTimeout(() => {
    removeTyping(typingId);
    const reply = generateChatReply(text, CHAT_CONTEXT.result, CHAT_CONTEXT.history);
